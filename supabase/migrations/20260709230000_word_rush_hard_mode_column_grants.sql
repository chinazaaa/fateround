-- Re-grant column-level SELECT on games/players after word_rush_difficulty was added.
--
...
-- "permission denied for table games" (42501) — including Word Rush host/player panels
-- that load GAME_SELECT with word_rush_difficulty.
