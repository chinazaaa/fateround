...
(the cross-game player spine) and **Host** — so a dedicated player _or_ host each has a
...
| Tier        | Trophy                  | Description                                          | Owner     | Criteria                                   |
| ----------- | ----------------------- | ---------------------------------------------------- | --------- | ------------------------------------------ |
| 🥉 Bronze   | Collect $200            | Pass PAYDAY for the first time.                      | 🎮 Player | `event monopoly.first_go`                  |
| 🥈 Silver   | Lap Runner              | Pass PAYDAY 50 times across all games.               | 🎮 Player | `counter monopoly.go_passes ≥ 50`          |
| 🥇 Gold     | Marathon Mogul          | Pass PAYDAY 200 times across all games.              | 🎮 Player | `counter monopoly.go_passes ≥ 200`         |
...
5. ✅ **Host streak semantics** — **host activity feeds the same account `streak`** (play _or_
