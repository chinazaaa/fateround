...
## PAGE 1 — Free Jackbox Alternative
...
- No download and no sign-up — share a code, play in the browser
- 20+ games in one room — not one pack at a time
- Works over Discord, Zoom, or FaceTime — everyone joins from their own phone

### Feature cards
- ⚡ **No sign-up** — Create a game and play in seconds. Nobody makes an account.
- 💸 **Actually free** — Every mode, free forever. No pack to unlock, no card to enter.
- 📱 **Phone = controller** — Just like Jackbox, but there's no host screen to buy or run. Your phone is the whole game.
- 🎲 **More than party trivia** — Voting games, board classics, card games, word and trivia — one link covers the whole night.

### How it works
1. **Pick a game.** Smash Marry Kill, Would You Rather, Trivia, Monopoly — whatever the group's in the mood for.
2. **Share the code.** Send one short room code or link. Everyone joins from any browser.
...
| Account | None | Steam/host account (players join free) |
| How players join | Share a code, any browser | Room code to a host screen |
| Game breadth | 20+ — voting, board, card, trivia | ~5 games per pack |
| Best for | Friends over any call, instantly | Streamers, one shared screen |
...
**Can we play over Discord or Zoom?**
Yes — that's the sweet spot. Start a call, share the room code, and everyone plays from their own phone while you talk.

**Is it like Jackbox where my phone is the controller?**
Exactly like that — minus the host screen you have to buy and run. Your phone is the whole game.

---
---

## PAGE 2 — Games to Play on FaceTime / Video Call
...
- Everyone joins from their own phone with one shared code
- Free forever, no download, no account
- 20+ games — start with a quick vote, end on a full board-game night

### Feature cards
- 📞 **Plays beside your call** — No screen-share gymnastics. Your call stays open; the game runs in the browser next to it.
- 🔗 **One link, everyone's in** — Drop the code in the group chat or Discord. Players join in seconds from any browser.
- 🎭 **From icebreaker to chaos** — Warm up with Would You Rather, escalate to Smash Marry Kill, cool down with Codewords.
- 📱 **Any device** — iPhone, Android, laptop — everyone plays from whatever's in their hand.

### How it works
1. **Start your call** — FaceTime, Zoom, Discord, Meet. Whatever you already use.
2. **Create a game and share the code** — One short link in the chat. Everyone taps in.
...
- **Trivia** — fastest correct answer wins. Great for bigger groups.
- **Codewords** — two teams, one call, one spymaster each. Perfect for Discord.
- **Monopoly / Whot / Ludo** — when the call turns into a proper game night.
...
**Is it free?**
Yes, free forever — no sign-up and no download.
...
## PAGE 3 — Games for Long Distance Couples & Friends
...
- Real-time play from anywhere — one link, both of you in
- Free forever, no download, no account to make
- Voting and connection games plus Chess, Checkers, Whot, and Crazy Eights

### Feature cards
- 💌 **Closer, not just on a call** — Something to *do* together, not just a screen to stare at.
- ♟️ **Two-player classics** — Chess, Checkers, Crazy Eights, Whot — settle it head-to-head.
- 🤍 **Learn each other** — Would You Rather, Never Have I Ever, and This or That, built for two.
- 🔁 **Comes back easy** — No account means no barrier. One link, any night, you're playing.

### How it works
1. **Pick a game** — a fast voting round to warm up, or a two-player board game to settle a score.
2. **Send the link** — one code by text or chat. They tap in from wherever they are.
...
- **Chess / Checkers** — slow head-to-head when you want to actually compete.
...
## Prioritized backlog (next pages to build)

Ranked by leverage (demand × fit × winnability × AI-citation likelihood):

1. **Games to play on Discord (no bot, no download — just a link)** — weakly answered by competitors; high fit. Could be split from Page 2 into its own page.
2. **Free online party games — no sign-up, no download (hub page)** — the head term; internally links to every mode. Anchor for the whole cluster.
3. **Free Kahoot alternative (no login, no player limit)** — exploits Kahoot's 10-player free cap; strong existing demand.
...
## Review & scores (adversarial pass, post-fix)

An independent review scored each draft on brand voice (25%), accuracy (30%), SEO/AEO (25%), and persuasion (20%). Scores below are pre-fix; the accuracy issues it flagged have now been corrected in the drafts above.

| Page | Voice | Accuracy | SEO/AEO | Persuasion | Weighted |
|---|---|---|---|---|---|
| 1 — Free Jackbox Alternative | 9 | 6 → **fixed** | 8 | 9 | 7.9 |
| 2 — Video Call Games | 9 | 7 | 9 | 8 | 8.2 |
| 3 — Long Distance Games | 9 | 4 → **fixed** | 8 | 8 | 7.1 |

**Fixes applied:** (1) Page 3 no longer recommends 3+ player games (Most Likely To, Two Truths, Who Said This) to a two-player couples audience — rebuilt from verified 2-player modes, with the group modes demoted to a "when a third joins" line. (2) Page 1's Jackbox price is now hedged and dated. (3) Page 2's SEO title trimmed under the 60-char truncation limit. (4) CTA + internal-link + FAQ-schema guidance added for all three.

**Still your call before publishing:** confirm the exact routes/slugs you want, and whether these live as marketing routes or as entries in the `game-landing` system.

---

*Sources for research behind these pages: FaceTime/Zoom/Discord game listicles (teambuilding.com, sessionlab.com, thegamer.com), Jackbox-alternative roundups (cbr.com, gamebuddies.io, textgame.ai), long-distance guides (paired.com, endlessdistances.com), and competitor sites (jackboxgames.com, gamebuddies.io, kahoot.com, boardgamearena.com, psycatgames.com).*
