import type { UnoColor } from '@fateround/shared'
 ...
 * Ephemeral: broadcast over realtime, never persisted. Mirrors web's
 * src/lib/uno-quick-messages.ts exactly — same ids so both platforms interop
 * over the same `uno-quickchat:<gameCode>` broadcast channel.
 */
