...
export const WHOT_SESSION_SELECT =
  'id,game_id,turn_order,current_turn_index,phase,draw_count,discard_count,top_card,required_shape,required_number,pick_two_stack,pick_five_stack,status_message,winner_player_id,finish_order,reshuffle_count,turn_deadline_at'
