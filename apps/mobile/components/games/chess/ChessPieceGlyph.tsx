 ...
 * widely-used SVGs; CC-BY-SA / GPL) on a 45×45 grid, re-parametrised so a single
 * shape tints for either side:
 *   - `body`    fills the piece,
 *   - `outline` strokes its silhouette + internal contours,
 *   - `detail`  draws the interior "ink" lines/accents.
 * Ported from src/components/chess/ChessPieceDetailed.tsx to react-native-svg.
 */
...
function PieceShape({ type, body, outline, detail }: { type: ChessPieceType } & Colors) {
  switch (type) {
    ...
    case 'r':
      return (
        <G translateY={0.3}>
          <Path d="M 9,39 L 36,39 L 36,36 L 9,36 L 9,39 z" fill={body} stroke={outline} strokeLinecap="butt" />
          <Path d="M 12,36 L 12,32 L 33,32 L 33,36 L 12,36 z" fill={body} stroke={outline} strokeLinecap="butt" />
          <Path
            ...
            strokeLinecap="butt"
          />
          <Path d="M 34,14 L 31,17 L 14,17 L 11,14" fill={body} stroke={outline} />
          <Path
          ...
          />
          <Path d="M 31,29.5 L 32.5,32 L 12.5,32 L 14,29.5" fill={body} stroke={outline} />
          <Path d="M 11,14 L 34,14" fill="none" stroke={detail} strokeLinejoin="miter" />
        </G>
      )
    case 'n':
      return (
        ...
        <G translateY={0.6}>
          <G strokeLinecap="butt">
            ...
            <Path
              ...
              stroke={outline}
            />
            <Path d="M 25 8 A 2.5 2.5 0 1 1  20,8 A 2.5 2.5 0 1 1  25 8 z" fill={body} stroke={outline} />
          </G>
          <Path
    ...
    case 'q':
      return (
        <G>
          ...
          <Circle cx={6} cy={12} r={2} fill={body} stroke={outline} />
          <Circle cx={14} cy={9} r={2} fill={body} stroke={outline} />
          <Circle cx={22.5} cy={8} r={2} fill={body} stroke={outline} />
          <Circle cx={31} cy={9} r={2} fill={body} stroke={outline} />
          <Circle cx={39} cy={12} r={2} fill={body} stroke={outline} />
        </G>
      )
    case 'k':
      return (
        <G>
          <Path d="M22.5 11.63V6M20 8h5" fill="none" stroke={detail} strokeLinejoin="miter" />
          <Path
