...
/** Ported from src/lib/chess-premove.ts — lichess-style premove target squares. */
 ...
 * lichess-style premove rule. Occupancy, checks, and pins are ignored; the
 * queued move is re-validated against the real position once it becomes the
 * player's turn, and silently dropped if it turned out illegal.
 */
