...
// Mirrors web WordSearchGameTimerBar: a "Puzzle time left" countdown bar driven by the
...
export function WordSearchGameTimerBar({
  ...
  useEffect(() => {
    ...
    const fire = async () => {
      try {
        await fetch(apiUrl(`/api/games/${gameCode.toUpperCase()}/expire-word-search`), { method: 'POST' })
      } catch {
