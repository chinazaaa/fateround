...
const makeStyles = (theme: Theme) =>
  StyleSheet.create({
    ...
    subtitle: { color: theme.textMuted, fontSize: theme.type.label.size, lineHeight: 20 },
    ...
    removeText: { color: theme.textMuted, fontSize: theme.type.body.size, fontWeight: '700' },
    ...
    addButtonText: { color: theme.primaryMuted, fontSize: theme.type.label.size, fontWeight: '800' },
    importButton: {
      paddingVertical: theme.space.sm,
      paddingHorizontal: theme.space.md,
      borderRadius: theme.radius.pill,
    ...
    footHint: { color: theme.textFaint, fontSize: theme.type.caption.size },
  })
