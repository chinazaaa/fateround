                      ...
                      {CUSTOM_SLOT_COLORS.map((c) => (
                        <Pressable
                          ...
                          style={[
                            styles.colorOption,
                            { backgroundColor: c },
                            slot.color === c && styles.colorOptionOn,
                          ]}
                          onPress={() => {
...
const makeStyles = (theme: Theme) =>
  ...
  footHint: { color: theme.textFaint, fontSize: 12, lineHeight: 17 },
  ...
  templateTitle: { color: theme.text, fontSize: 14, fontWeight: '700', flex: 1 },
  templateMeta: { color: theme.textFaint, fontSize: 12 },
