    ...
    <footer className="site-footer">
      <div className="foot-inner">
        ...
        <p className="foot-legal">
          ...
          Yahtzee®, Monopoly®, Scrabble®, UNO® or any other game. All trademarks are the property of their respective
          owners and are used here only to describe the game being played.
        </p>
      </div>
    </footer>
  )
