    ...
    <>
      ...
      <aside className={`fr-drawer${menu ? ' on' : ''}`} aria-hidden={!menu}>
        ...
        <div className="fr-drawer-cta">
          <Link href="/create" className="fr-btn fr-btn--primary fr-btn--lg fr-btn--block" onClick={() => setMenu(false)}>
            Create a Game
          </Link>
          <Link href="/games" className="fr-btn fr-btn--secondary fr-btn--lg fr-btn--block" onClick={() => setMenu(false)}>
            Browse games
          </Link>
        </div>
      </aside>
