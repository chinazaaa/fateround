      ...
      <div className="mk-wrap pt-2 pb-4">
        ...
        <section className="grid items-center gap-10 lg:grid-cols-[1.05fr_0.95fr] lg:gap-14 pt-6 lg:pt-10">
          <div>
            ...
            <p className="mt-5 max-w-[30rem] text-[1.0625rem] leading-[1.55] lg:text-lg" style={{ color: 'var(--text-muted)' }}>
          ...
          <div className="fr-card fr-card--xl" style={{ boxShadow: 'var(--shadow-lg)' }}>
            <p className="mb-3.5 text-xl tracking-[-0.02em]" style={{ ...displayFont, fontWeight: 800, color: 'var(--text)' }}>
            ...
            <div className="mt-4 grid grid-cols-2 gap-3">
              <Link
                href="/rooms"
                className="fr-card fr-card--interactive flex items-center gap-3 !p-3.5 no-underline"
              >
        ...
        <div className="mt-10 mb-4 flex items-baseline justify-between">
          <h2 className="m-0 text-[22px] tracking-[-0.02em]" style={{ ...displayFont, fontWeight: 800, color: 'var(--text)' }}>
            Popular games
          </h2>
