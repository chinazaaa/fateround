...
export function GameHostChrome() {
  ...
  return (
    <>
      <header className="game-host-chrome fixed top-0 inset-x-0 z-40 flex items-center justify-between gap-2 sm:gap-3 px-3 sm:px-4 py-2.5 sm:py-3 pointer-events-none border-b border-[var(--border)]/50 bg-[var(--background)]/90 backdrop-blur-md">
