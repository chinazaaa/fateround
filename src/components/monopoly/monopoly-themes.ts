...
// Snowflake/holly motif art, sleigh-route stations, festive utilities, and
// Coal Bin / Cozy Fireside / On the Naughty List corners. Currency stays '$'
// per the spec — the star / snowflake goes into art, not the money symbol.
// ---------------------------------------------------------------------------

const CHRISTMAS_PALETTE: MonopolyBoardPalette = {
  boardBg:
    'bg-gradient-to-br from-[#F6EFD7] via-[#EADFC0] to-[#D7C79A] dark:from-[#0F2A1A] dark:via-[#0A1F13] dark:to-[#05130A]',
  boardBorder: 'border-[#C8102E]/70 dark:border-[#C8102E]/70',
  boardShadow:
    'shadow-[0_20px_60px_rgba(41,64,45,0.28),inset_0_1px_0_rgba(255,255,255,0.55)] dark:shadow-[0_20px_60px_rgba(3,12,7,0.85),inset_0_1px_0_rgba(200,16,46,0.22)]',
  centerBg:
    'bg-gradient-to-br from-[#F8F1D9]/95 via-[#EEDDB5]/90 to-[#DDC895]/95 dark:from-[#123821]/95 dark:via-[#0E2A19]/90 dark:to-[#081910]/95',
  centerBorder: 'border-[#C8102E]/45 dark:border-[#B9862B]/40',
  centerText: 'text-[#1B2A20] dark:text-[#F6EFD7]',
  centerSubtleText: 'text-[#0F5132]/85 dark:text-[#B9862B]/85',
  centerPriceText: 'text-[#0F5132] dark:text-[#B9862B]',
  centerDebtPriceText: 'text-[#C8102E] dark:text-[#F4A4A4]',
  titleColor: 'text-[#0F5132] dark:text-[#B9862B]',
  subtitleColor: 'text-[#C8102E] dark:text-[#F6EFD7]/85',
  tileBg: 'bg-[#FBF6E4] dark:bg-[#123821]',
  tileBorder: 'border-[#0F5132]/40 dark:border-[#B9862B]/30',
  tileText: 'text-[#1B2A20] dark:text-[#F6EFD7]',
  highlightRing: 'ring-[#C8102E] dark:ring-[#B9862B]',
  highlightOffset: 'ring-offset-[#EADFC0] dark:ring-offset-[#0F2A1A]',
  priceText: 'text-[#0F5132] dark:text-[#B9862B]',
  rentText: 'text-[#C8102E] dark:text-[#F6EFD7]/85',
  cornerDivider: 'bg-[#C8102E]/30 dark:bg-[#B9862B]/30',
  myTokenRing: 'ring-[#0F5132] dark:ring-[#B9862B]',
  myTokenOffset: 'ring-offset-[#EADFC0] dark:ring-offset-[#0F2A1A]',
  titleFont: 'font-sans font-black text-sm sm:text-3xl tracking-wide',
  subtitleFont: 'font-sans font-semibold tracking-widest text-xs sm:text-sm uppercase',
  tileFont: 'font-sans font-bold tracking-tight',
  customDecoration: 'none',
...
const CHRISTMAS_EDITION: MonopolyThemeEdition = {
  themeId: 'christmas',
  editionName: 'Christmas',
  editionEmoji: '❄️',
  currencySymbol: '$',
  currencyWord: 'dollars',
