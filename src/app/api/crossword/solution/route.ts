...
// Reveals the answer grid — ONLY for a finished game. During play the solution stays in the
// RLS-protected crossword_solutions table; here the service role reads it once the race is over.
export async function GET(req: NextRequest) {
  ...
  return NextResponse.json({ solution: (sol?.solution as string[][] | undefined) ?? null })
}
