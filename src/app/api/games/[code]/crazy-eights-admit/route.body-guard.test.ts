...
import { codeParams, jsonRequest } from '@/test-support/host-auth'

/**
 * Request-body guard for POST /api/games/abcd/crazy-eights-admit.
 *
...
// cases are expressed.
const post = (body: string) => POST(jsonRequest('/api/games/abcd/crazy-eights-admit', body), codeParams())

describe('POST /api/games/abcd/crazy-eights-admit — request body guard', () => {
