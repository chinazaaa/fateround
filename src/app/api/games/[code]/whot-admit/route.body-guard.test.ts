...
/**
 * Request-body guard for POST /api/games/abcd/whot-admit.
 *
...
// cases are expressed.
const post = (body: string) => POST(jsonRequest('/api/games/abcd/whot-admit', body), codeParams())

describe('POST /api/games/abcd/whot-admit — request body guard', () => {
