...
/**
 * Request-body guard for POST /api/mahjong/draw.
 *
...
// cases are expressed.
const post = (body: string) => POST(jsonRequest('/api/mahjong/draw', body))

describe('POST /api/mahjong/draw — request body guard', () => {
