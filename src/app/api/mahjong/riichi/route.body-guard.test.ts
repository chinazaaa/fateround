...
/**
 * Request-body guard for POST /api/mahjong/riichi.
 *
...
// cases are expressed.
const post = (body: string) => POST(jsonRequest('/api/mahjong/riichi', body))

describe('POST /api/mahjong/riichi — request body guard', () => {
