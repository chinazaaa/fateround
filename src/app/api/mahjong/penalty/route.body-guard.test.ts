...
/**
 * Request-body guard for POST /api/mahjong/penalty.
 *
...
// cases are expressed.
const post = (body: string) => POST(jsonRequest('/api/mahjong/penalty', body))

describe('POST /api/mahjong/penalty — request body guard', () => {
