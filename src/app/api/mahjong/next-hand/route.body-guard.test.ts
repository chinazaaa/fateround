...
/**
 * Request-body guard for POST /api/mahjong/next-hand.
 *
...
// cases are expressed.
const post = (body: string) => POST(jsonRequest('/api/mahjong/next-hand', body))

describe('POST /api/mahjong/next-hand — request body guard', () => {
