...
/**
 * Request-body guard for POST /api/mahjong/discard.
 *
...
// cases are expressed.
const post = (body: string) => POST(jsonRequest('/api/mahjong/discard', body))

describe('POST /api/mahjong/discard — request body guard', () => {
