...
/**
 * Request-body guard for POST /api/mahjong/pass.
 *
...
// cases are expressed.
const post = (body: string) => POST(jsonRequest('/api/mahjong/pass', body))

describe('POST /api/mahjong/pass — request body guard', () => {
