...
// Fresh per request (not ISR): a notFound() from a not-yet-claimed username must never be cached
// and served as a stale 404 once the profile exists.
...
export default async function PublicTrophiesPage({ params }: Props) {
  ...
  return (
    <div className="fr-site min-h-dvh pb-14">
      ...
      <div className="mx-auto max-w-2xl px-4 pt-6 sm:px-6">
        ...
        <p className="text-faint pt-8 text-center text-xs">
