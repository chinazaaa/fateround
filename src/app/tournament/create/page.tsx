          ...
          <p className="text-faint text-xs mt-2">
            {isH2H
              ...
              : isKnockout
                ...
                : isSchool
                  ? 'School Whot: everyone starts in the lowest class and is grouped with classmates into a timed Whot room (up to 5) each round. Empty your hand to climb a class; when time’s up the player left holding the most cards repeats. Get left alone in a class while others move up and you’re out. First to graduate past the top class wins.'
