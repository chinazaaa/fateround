        ...
        <div className="mk-wrap">
          <article className="mx-auto max-w-2xl">
            ...
            <div className="mt-4 flex flex-wrap items-center gap-2 text-xs" style={{ color: 'var(--text-muted)' }}>
              ...
              <span aria-hidden>·</span>
              <span style={{ color: 'var(--primary)' }}>{post.author}</span>
            </div>

            <h1
              className="mt-3 text-3xl font-bold leading-[1.1] tracking-tight sm:text-4xl"
              style={{ color: 'var(--text)' }}
            >
              {post.title}
            </h1>
            <p className="mt-3 text-[17px] leading-relaxed" style={{ color: 'var(--text-muted)' }}>
              {post.excerpt}
            </p>
