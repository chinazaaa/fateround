...
import {
  ...
  AYO_DEFAULT_MAX_PLAYERS,
  AYO_MAX_PLAYERS,
  AYO_MIN_PLAYERS,
  BINGO_DEFAULT_MAX_PLAYERS,
  BINGO_MAX_PLAYERS,
  BINGO_MIN_PLAYERS,
  CHECKERS_DEFAULT_MAX_PLAYERS,
  CHECKERS_MAX_PLAYERS,
  CHECKERS_MIN_PLAYERS,
  CHESS_DEFAULT_MAX_PLAYERS,
  CHESS_MAX_PLAYERS,
  CHESS_MIN_PLAYERS,
  ...
  DRAUGHTS10_DEFAULT_MAX_PLAYERS,
  DRAUGHTS10_MAX_PLAYERS,
  DRAUGHTS10_MIN_PLAYERS,
  GOFISH_DEFAULT_MAX_PLAYERS,
  GOFISH_MAX_PLAYERS,
  GOFISH_MIN_PLAYERS,
  LANDMINE_DEFAULT_MAX_PLAYERS,
  LANDMINE_MAX_PLAYERS,
  ...
  WORD_SEARCH_DEFAULT_MAX_PLAYERS,
  WORD_SEARCH_MAX_PLAYERS,
  WORD_SEARCH_MIN_PLAYERS,
  YAHTZEE_DEFAULT_MAX_PLAYERS,
  YAHTZEE_MAX_PLAYERS,
  YAHTZEE_MIN_PLAYERS,
