...
export const createGameSchema = z.object({
  ...
  mafia_mayor_enabled: z.boolean().optional(),
  mafia_vigilante_enabled: z.boolean().optional(),
  mafia_tracker_enabled: z.boolean().optional(),
  mafia_alpha_wolf_enabled: z.boolean().optional(),
  mafia_wolf_cub_enabled: z.boolean().optional(),
  mafia_framer_enabled: z.boolean().optional(),
  mafia_jester_enabled: z.boolean().optional(),
  mafia_serial_killer_enabled: z.boolean().optional(),
  mafia_arsonist_enabled: z.boolean().optional(),
  mafia_cupid_enabled: z.boolean().optional(),
  mafia_cursed_villager_enabled: z.boolean().optional(),
  mafia_aura_seer_enabled: z.boolean().optional(),
  mafia_medium_enabled: z.boolean().optional(),
  mafia_priest_enabled: z.boolean().optional(),
  mafia_witch_enabled: z.boolean().optional(),
  mafia_little_girl_enabled: z.boolean().optional(),
  mafia_trapper_enabled: z.boolean().optional(),
  mafia_seer_enabled: z.boolean().optional(),
  mafia_mafia_seer_enabled: z.boolean().optional(),
  mafia_red_lady_enabled: z.boolean().optional(),
