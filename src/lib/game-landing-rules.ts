  ...
  mafia: [
    ...
    },
    {
      ...
      points: [
        ...
        'The Witch may use a heal potion, a kill potion, both, or neither (each once per game).',
        'The Little Girl secretly sees who the Mafia targeted, risking a chance of being caught and killed.',
        'The Trapper sets a trap on one house — if the Mafia targets it, the kill is blocked and the culprits are revealed to the Trapper.',
