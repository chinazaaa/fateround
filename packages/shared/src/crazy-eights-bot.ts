...
import { canPlayCard, cardPoints, isJoker, isWildCard, type CrazyEightsRules } from './crazy-eights'
import { CRAZY8_SOLO_BOT_ID, type Crazy8SoloAction, type Crazy8SoloState } from './crazy-eights-solo'
